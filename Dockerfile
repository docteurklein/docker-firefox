...
RUN echo     && curl https://ftp.mozilla.org/pub/mozilla.org/firefox/releases/10.0.1/linux-x86_64/fr/firefox-10.0.1.tar.bz2 > firefox.bz2     && tar jxf firefox.bz2     && rm firefox.bz2
